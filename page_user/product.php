                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item"> 
                                ...
                                <small class="w-50 text-center border-end py-2">
                                         ...
                                         <a  type="button" class="text-body" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                         <i class="fa fa-eye text-primary me-2"></i>รายละเอียด</a>
                                    ...
                                    <small class="w-50 text-center py-2">
                                        <a class="text-body" href="basket.php?id=<?=$data['med_id']?>"><i class="fa fa-shopping-bag text-primary me-2"></i>Add to cart</a>
                                    </small>
                                </div>
                            </div>
                        </div>
