...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        // Initialize the count to 1 if it hasn't been set yet
        if (!isset($_SESSION['sitem'][$id])) {
          $_SESSION['sitem'][$id] = 1;
        } else {
          // Do not increment the count if it has already been set
        }
      
        // Store the other data in session variables as before
...
<div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
	...
	<div class="app-card-body">
		<div class="table-responsive">
			<table class="table app-table-hover mb-0 text-left">
				<thead> 
                    ...
                    <tr>
                        <td><?=$i;?></td>
                        <td><img src="../fron/admin/product/upload_product/<?=$_SESSION['simage'][$tid];?>" width="100" height="100"></td>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a href="record.php?id=<?=$data['id']?>" class="btn btn-success rounded-pill ms-12 mt-2 py-sm-3 px-sm-3 me-md-2">ชำระเงิน</a>
        </div>
	</div><!--//app-card-body-->		
</div><!--//app-card-->
</div><!--//tab-pane-->
