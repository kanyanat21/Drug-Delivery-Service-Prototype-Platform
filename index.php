        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="d-none d-lg-flex ms-2">
                    <a class="btn-sm-square bg-danger rounded-circle ms-3" href="">
                        <small class="bi bi-cart-fill text-body"></small>
                    </a>
                    <div class="app-utility-item app-user-dropdown dropdown">
                        <a class="btn-sm-square bg-danger rounded-circle ms-3" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><small class="fa fa-user text-body"></small></a>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    ...
                                    <a href="login/signup.php" class="btn btn-danger rounded-pill py-sm-3 px-sm-5">SignUp</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    ...
                    <?php foreach($result_tb_type_product as $data):?>
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-primary border-2" data-bs-toggle="pill" href=""><?=$data['title'];?></a>
                        </li>
                        <?php endforeach;?>
                    </ul>
                </div>
                ...
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <?php endforeach;?>
                        ...
                        <div class="col-12 text-center">
                            <a href="product/product.php" class="btn btn-danger rounded-pill py-sm-3 px-sm-5">Browse More Products</a>
                        </div>
                    </div>
                </div>
            </div>
