<?php
   include("../connectdb.php");
    ...
    $sql = "SELECT * FROM tb_admin WHERE name LIKE '%$name%' ORDER BY name ASC ";
...
<div class="app-wrapper">
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<div class="col-auto">
			<h1 class="app-page-title mb-0">รายชื่อผู้ดูแลระบบ</h1>
			<br>

			<div class="card-body">
			<a href="add_admin.php" class="btn btn-outline-info" >เพิ่มข้อมูล</a>
			...
			<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
				<div class="col-auto">
					<form action="search_admin.php" class="table-search-form row gx-1 align-items-center" method="POST">
						<div class="col-auto">
							<input type="text"  name="name" class="form-control " required>
						</div>
						<div class="col-auto">
							<input type="submit" class="btn app-btn-secondary" value="ค้นหา">
						</div>
		...
		<table class="table app-table-hover mb-0 text-left">
			...
			<tbody>
				...
				<tr>
					...
					<td>
			<a href="edit_admin.php?id=<?php echo $data["id"] ?>" class="btn btn-outline-warning" >แก้ไข</a>
			<a href="deletedata.php?id=<?php echo $data["id"] ?>" class="btn btn-outline-danger" onclick="return confirm('ยืนยันการลบข้อมูล')" >ลบ</a>
			</td>
				</tr>
				<?php } ?>
			</tbody>
