...
<div class="app-wrapper">
	...
	<div class="container-xl">
		...
		<div class="col-auto">
			<h1 class="app-page-title mb-0">ข้อมูลสินค้า</h1>
		</div>
		<div class="col-auto">
				...
				<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
					...
					<div class="col-auto">
						<a class="btn app-btn-primary" href="../product/add_product.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-upload me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<table class="table app-table-hover mb-0 text-left">
				<thead> 
					<tr>
						...
						<th class="cell">ประเภทยา</th>
						<th class="cell">ชื่อ</th>
						<th class="cell">รายละเอียด</th>
						<th class="cell">ราคาซื้อ</th>
						<th class="cell">ราคาขาย</th>
				...
				<tr>
				<td><?=$data['med_id'];?> </td>
				<td><img src="upload_product/<?=$data['image'];?>" width="100" height="100"></td>
				<td><?=$data['title_type_product'];?> </td>
				<td><?=$data['med_name'];?></td>
				<td><?=$data['med_detail'];?></td>
				<td><?=$data['med_price'];?></td> 
				<td><?=$data['med_cost'];?></td>
				<td>
				<a href="edit_product.php?med_id=<?php echo $data["med_id"] ?>" class="btn btn-warning" >แก้ไข</a>
				<a href="deletedata.php?med_id=<?php echo $data["med_id"] ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')" >ลบ</a>
				</td>
