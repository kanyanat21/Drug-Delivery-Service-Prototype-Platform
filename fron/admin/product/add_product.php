	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		...
		<hr class="mb-4">
	        ...
	        <div class="col-12 col-md-4">
				<h1 class="app-page-title">เพิ่มข้อสินค้า</h1> 
					...
					<div class="app-card app-card-settings shadow-sm p-4">
						...
						<?php
							      if(isset($_POST) && !empty($_POST)){
									...
									//echo $filename; 
									//exit();
									$sql = "INSERT INTO tb_product(type_product_id,med_name,med_detail,med_price,med_cost,image) VALUES ('$type_product_id','$med_name','$med_detail','$med_price','$med_cost','$filename')";
									if(mysqli_query($conn,$sql)){
										$alert .= '<script type="text/javascript">';
										$alert .= 'alert("เพิ่มข้อมูลสำเร็จ");';
										$alert .= 'window.location = "product.php";';
										$alert .= '</script>';
										echo $alert;
										exit();
							...
							<form action="" method="post" enctype= multipart/form-data>
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="med_detail"  required>
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="med_cost" required>
								</div>
