	...
	<div class="container-xl">
		...
		<div class="col-auto">
				...
				<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
					...
					<div class="col-auto">
						<a class="btn btn-success" href="add_admin.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-upload me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
