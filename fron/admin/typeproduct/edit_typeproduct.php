...
<body class="app">   	
    ...
    <div class="app-wrapper">
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<h3 class="section-title">แก้ไขข้อมูลประเภทสินค้า</h3>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-8">
                        <br>
		                <a href="typeproduct.php" class="btn btn-secondary text-white mb-4 float-right">ย้อนกลับ</a>
                        <br>
                        <br>
		                <div class="app-card app-card-settings shadow-sm p-4">   
						    <div class="app-card-body">

							    <form action="update_typeproduct.php" method="POST">
