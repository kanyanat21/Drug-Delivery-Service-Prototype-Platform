	        ...
	        <div class="sidepanel-inner d-flex flex-column">
			    ...
			    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link active" href="../typeproduct/typeproduct.php">
						        <span class="nav-icon">
	...
	<div class="container-xl">
		...
		<div class="col-auto">
				...
				<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
					...
					<div class="col-auto">
						<a class="btn app-btn-primary" href="../typeproduct/add_typeproduct.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-upload me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						<path fill-rule="evenodd" d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
						<path fill-rule="evenodd" d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
						</svg>เพิ่มประเภทสินค้า</a>
					</div>
				</div><!--//row-->
			</div><!--//table-utilities-->
		</div><!--//col-auto-->
	...
	<div class="app-card-body">
		<div class="table-responsive">
			<table class="table app-table-hover mb-0 text-left">
				...
				<td><?=$data['title'];?></td>
				<td>
				<a href="edit_typeproduct.php?id=<?php echo $data["id"] ?>" class="btn btn-warning" >แก้ไข</a>
