...
<body class="app">   	
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
			    ...
			    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link active" href="../list/list.php">
								<span class="nav-icon">
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<div class="col-auto">
				<h1 class="app-page-title mb-0">รายงานการขาย</h1>
			</div>
			<div class="col-auto">
				...
				<table class="table app-table-hover mb-0 text-left">
					...
					<div class="row g-2">
						<div class="col-md">
							<div class="form-floating">
								<input type="date" class="form-control" id="floatingInputGrid" placeholder="20-09-65" value="20-09-65">
								<label for="floatingInputGrid">ตั้งแต่วันที่</label>
							</div>
						</div>
						<div class="col-md">
							<div class="form-floating">
								<input type="date" class="form-control" id="floatingInputGrid" placeholder="20-09-65" value="20-09-65">
								<label for="floatingInputGrid">ถึงวันที่</label>
							</div>
						</div>    
					</div>
					<div class="col-auto">
						<button type="submit" class="btn btn-success">ค้นหา</button></div>
					...
					<thead>
						<tr>
							...
							<th class="cell">จำนวนที่ขาย</th>
							<th class="cell">จำนวนเงิน</th>
					...
					<tr>
					<td><img src="../upload/<?=$data['image'];?>" width="100" height="100"></td>
					<td><?=$data['id'];?></td>
					<td><?=$data['name'];?> </td>
					<td><?=$data['price'];?></td>
					<td><?=$data['detail'];?></td>
					...
					<td>
					<a href="edit_list.php?id=<?php echo $data["id"] ?>" class="btn btn-outline-warning" >แก้ไข</a>
					<a href="delete_list.php?id=<?php echo $data["id"] ?>" class="btn btn-outline-danger" onclick="return confirm('ยืนยันการลบข้อมูล')" >ลบ</a>
				</td>
					</tr>
  <?php  }  ?>
</table><br>
