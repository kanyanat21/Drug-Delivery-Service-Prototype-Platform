		    ...
		    <div class="container-xl">	
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">รายงานการขาย</h3>
                        <br>
		                <a href="list.php" class="btn app-btn-primary">ย้อนกลับ</a>
	                </div>
						    ...
						    <div class="app-card-body">
							    ...
							    <form action="" method="post" enctype= multipart/form-data>
									...
									<div class="mb-3">
									    ...
									    <textarea type="text" class="form-control" name="s_detail" ></textarea>
									</div>
								    <div class="mb-3"> 
