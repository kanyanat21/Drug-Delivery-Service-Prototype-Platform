...
<body class="app">   	
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<div class="col-auto">
			            <h1 class="app-page-title mb-0">รายชื่อสมาชิก</h1>
				    </div>
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">
								    <a class="btn app-btn-primary" href="add_customer.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-upload me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd" d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
										<path fill-rule="evenodd" d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
									</svg>เพิ่มข้อมูลลูกค้า</a>
							    </div>
						    </div><!--//row-->
					    </div><!--//table-utilities-->
				    </div><!--//col-auto-->
					    ...
					    <div class="app-card app-card-orders-table shadow-sm mb-5">
						    <div class="app-card-body">
							    <div class="table-responsive">
									...
									<tr>
										<td><?=$data['id'];?></td>
										<td><img src="upload_customer/<?=$data['image'];?>" width="50" height="50"></td>
										<td><?=$data['name'];?>
										<td><?=$data['user'];?></td>
										...
										<td><?=$data['phone'];?></td>
										<td>
											<a href="edit_cus.php?id=<?php echo $data["id"] ?>" class="btn btn-warning" >แก้ไข</a>
											<a href="deletedata.php?id=<?php echo $data["id"] ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')" >ลบ</a>
										</td>		
									</tr>
									<?php  }  ?>
