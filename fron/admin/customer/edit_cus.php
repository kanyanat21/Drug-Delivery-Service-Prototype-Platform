        ...
        if(in_array($ext,$extension)){
            if(!file_exists($target.$filename)){
                if(move_uploaded_file($filetmp,$target.$filename)){
                    ...
                    $alert .= 'window.location.href = "customer.php";';
                    $alert .= '</script>';
                    echo $alert;
                    exit();
                }
...
<head>
    ...
    <meta name="description" content="ร้านค้าใกล้บ้าน">
...
<body class="app">   	
    ...
    <div class="app-wrapper">
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<h3 class="section-title">แก้ไขข้อมูลสมาชิก</h3>
			<a href="customer.php" class="btn btn-secondary text-white mb-4 float-right">ย้อนกลับ</a>
			    <hr class="mb-4">
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4"> 
						    ...
						    <div class="app-card-body">
							    ...
							    <form action="update_cus.php" method="post" enctype= multipart/form-data>
