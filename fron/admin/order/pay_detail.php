	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl"> 
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">รายละเอียดคำสั่งซื้อ เลขที่ <?=$_GET['a'];?></h1>
                        <br>
                        <a href="order.php" class="btn btn-secondary text-white mb-4 float-right">ย้อนกลับ</a>
				    </div>
				    <div class="col-auto">
					    ...
					    <div class="app-card app-card-orders-table shadow-sm mb-5">
						    <div class="app-card-body">
							    <div class="table-responsive">
									...
									$sql = "SELECT * from tb_orders_detail
									INNER JOIN tb_product ON tb_orders_detail.pid = tb_product.med_id
									WHERE tb_orders_detail.oid = '".$_GET['a']."'  ";
									//var_dump($sql);
									...
									<tr>
										<td><?=$i;?></td> 
										<td><img src="../product/upload_product/<?=$data['image'];?>" width="50" height="50"></td>
										<td><?=$data['med_id'];?></td>
										<td><?=$data['med_name'];?> </td>
										<td><?=$data['item'];?> </td>
										<td><?=number_format($data['med_cost'],0);?></td>
										
										<td>
										<a href="delete_res.php?res_id=<?php echo $data["res_id"] ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')" >ลบ</a>
										</td>
