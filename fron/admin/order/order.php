	        ...
	        <div class="sidepanel-inner d-flex flex-column">
			    ...
			    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link active" href="../order/order.php">
								<span class="nav-icon">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">คำสั่งซื้อ</h1>
				    </div>
				    <div class="col-auto">
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												<th class="cell">รหัสคำสั่งซื้อ</th>
												<th class="cell">รหัสลูกค้า</th>
												<th class="cell">วัน/เดือน/ปี/</th>
												<th class="cell">สถานะ</th>
												<th class="cell">รวมราคาสุทธิ</th>
									...
									<?php
									include("../connectdb.php");
									$sql = "select  *  from  `tb_order` order by oid  desc ";
									//var_dump($sql);
									...
									<td><?=$data['odate'];?> </td>
									<td>
										<a href="" class="btn btn-outline-warning">กำลังจัดส่ง</a>
										<a href="" class="btn btn-outline-danger">จัดส่งแล้ว</a>
									</td>
									<!--//<td>
										<?=($data['status'] == 0 ? '<spen class="badge bg-success">ชำระแล้ว</span>' : '<span class=badge bg-danger">ยังไม่ชำระ</span>')?>
									</td>-->
									<td><?=$data['ototal'];?></td>
									<td><a href="pay_detail.php?a=<?=$data['oid'];?>" class="btn btn-success" >รายละเอียด</a></td>
									<td><a href="reser_detail.php?a=<?=$data['oid'];?>" class="btn btn-info text-white mb-4 float-right">ที่อยู่</a> </td>
									<!--//<a href="edit_res.php?res_id=<?php echo $data["res_id"] ?>" class="btn btn-warning" >แก้ไข</a>-->
									<td><a href="delete_res.php?res_id=<?php echo $data["res_id"] ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')" >ลบ</a>
									</td>
